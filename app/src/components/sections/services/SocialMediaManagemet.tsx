  ...
  return (
    <section className=" flex flex-col lg:flex-row-reverse flex-wrap items-center py-20" id="OurService">
      <div className="w-full lg:w-1/2 flex justify-center p-4">
        <Image src={SocialMediaManagementImg} sizes="(max-width: 430px) 400px" loading="lazy" id="DesignsImage" alt="Imagen de diseños de sitios web en diferentes dispositivos" />
      </div>
